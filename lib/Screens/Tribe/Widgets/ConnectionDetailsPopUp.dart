        ...
        return  StatefulBuilder(
          builder: (BuildContext context, void Function(void Function()) setState) {
            return AlertDialog(
              ...
              content: SizedBox(
                height: !isPhone ? MediaQuery.of(context).size.height/2.5 : MediaQuery.of(context).size.height/3.5,
                      ...
                      child: Stack(
                        children: [
                          Container(
                            ...
                            child: Container(
                                padding:!isPhone ? const EdgeInsets.symmetric(vertical: 5) : const EdgeInsets.symmetric(vertical: 10),
                                height: 60,
                                width: 50,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            padding:const EdgeInsets.symmetric(horizontal: 5),
                            margin:const EdgeInsets.symmetric(vertical: 1),
                            child:  Text("You've shared: ${sharedModule.replaceAll(",", "/")}",textAlign: TextAlign.start,style: const TextStyle(fontSize:AppConstants.columnDetailsScreenFontSize,color: AppColors.containerBorder),),
                          ),
                          if(accessibleModule.isNotEmpty || accessibleModule!="")
                          Container(
                            padding:const EdgeInsets.symmetric(horizontal: 5),
                            margin:const EdgeInsets.symmetric(vertical: 1),
                            child:  Text("They shared: ${accessibleModule.replaceAll(",", "/")}",textAlign: TextAlign.start,style: const TextStyle(fontSize:AppConstants.columnDetailsScreenFontSize,color: AppColors.containerBorder),),
                          ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              padding:const EdgeInsets.symmetric(horizontal: 5),
                              margin:const EdgeInsets.symmetric(vertical: 1),
                              child:  Text("Shared Modules: ${module.replaceAll(",", "/")}",textAlign: TextAlign.start,style: const TextStyle(fontSize:AppConstants.columnDetailsScreenFontSize,color: AppColors.containerBorder),),
                            ),
