...
class _ColumnScreenState extends State<ColumnScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        width: MediaQuery.of(context).size.width,
        child: _isDataLoading || _isLoading ? const Center(child: CircularProgressIndicator(),) : SingleChildScrollView(
          child: Stack(
                        ...
                        children: [
                          ...
                          IconButton(onPressed: (){
                            ...
                            playerController = YoutubePlayerController(
                              ...
                              playerController.loadVideo(titleColumn);
