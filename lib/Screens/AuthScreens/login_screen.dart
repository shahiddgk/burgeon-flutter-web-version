 ...
 // final Future<bool> _isAvailableFuture = TheAppleSignIn.isAvailable();
  ...
  void _loginUser( String email, String password) {
    ...
    if(_formKey.currentState!.validate()) {
      ...
      HTTPManager().loginUser(LoginRequestModel(email: email,password: password)).then((value) async {
        // ignore: avoid_print
        print("LoginResponse");
        // ignore: avoid_print
        print(value);
  ...
  void _registerUser(String userName, String email, String password) {
    ...
    if(_formKey.currentState!.validate()) {
      ...
      HTTPManager().registerUser(RegisterRequestModel(name: userName,email: email,password: password,timeZone: _timezone)).then((value) {
        // ignore: avoid_print
