...
class _SettingsState extends State<Settings> {
                            ...
                            Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                   const Expanded(
                                       flex: 2,
                                       child: Text("Receive responses via email?",style: TextStyle(fontSize: AppConstants.defaultFontSize),)),
                                    Expanded(
                                      flex: 1,
                                      child: MediaQuery(
                            ...
                            Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    const Expanded(
                                        flex: 2,
                                        child: Text("Enable your coach to share tasks or notes?",style: TextStyle(fontSize: AppConstants.defaultFontSize),)),
                                    Expanded(
                                      flex: 1,
                                      child: MediaQuery(
                                        ...
                                        child: FlutterSwitch(
                                          ...
                                          onToggle: (val) {
                                            ...
                                            setState(() {
                                              print(userAccessStatus);
                                              print(userAccessText);
  ...
  void _deleteAccount(String id) {
    HTTPManager().deleteUser(LogoutRequestModel(userId: id)).then((value) async {
