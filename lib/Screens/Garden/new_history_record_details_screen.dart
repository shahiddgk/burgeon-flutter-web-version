...
class _AnswerDetailsScreenState extends State<AnswerDetailsScreen> {
  ...
  void initState() {
    ...
    print("ENTITY ID FOR DETAILS");
    print(widget.answerRecordId);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          margin: !isPhone ? EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width/4) : const EdgeInsets.symmetric(horizontal: 10),
          child: Column(
