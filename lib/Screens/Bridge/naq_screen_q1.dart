...
import '../Widgets/naq_scree_share_screen.dart';
...
class _NaqScreen1State extends State<NaqScreen1> {
  ...
  _getQuestions()  {
    ...
    HTTPManager().getNaqQuestions(NaqQuestionRequestModel(type: "naq")).then((value) {
      print(value);
                              ...
                              children: [
                                Container(
                                  ...
                                  child:  Text('Congratulation!',style: TextStyle(
                                      fontSize:isPhone ? AppConstants.mobileHeadingFontSize : isTable ? AppConstants.tabletHeadingFontSize  : AppConstants.headingFontSize,
                       ...
                       const SizedBox(
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            minimumSize: Size(!isPhone ? MediaQuery.of(context).size.width/5 : MediaQuery.of(context).size.width/2, 40), // Set the minimum width and height
                            padding: EdgeInsets.zero, // Remove any default padding
                          ),
