                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // ignore: prefer_const_constructors
                      Expanded(child: Text(widget.connectionModuleList,overflow: TextOverflow.ellipsis,style: TextStyle(color: AppColors.connectionTypeTextColor),)),
                    ],
                  ),
                  Row(
                    children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.symmetric(horizontal: !isPhone ? MediaQuery.of(context).size.width/8 : 5),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
