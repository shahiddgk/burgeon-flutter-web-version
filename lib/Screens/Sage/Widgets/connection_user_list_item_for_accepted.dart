...
class AcceptedConnectionListItem extends StatelessWidget {
  ...
  const AcceptedConnectionListItem({super.key,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 5,),
                            InkWell(onTap: (){
                              showConnectionDetailsPopUp(context,userName,connectionType,sharedModuleList,accessibleModuleList);
