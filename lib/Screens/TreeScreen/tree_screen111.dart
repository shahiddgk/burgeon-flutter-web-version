...
import 'package:flutter_quiz_app/model/request_model/chnage_tree_growth_type_request.dart';
import 'package:flutter_quiz_app/model/request_model/garden_seed_request_model.dart';
...
class TreeScreen1 extends StatefulWidget {
   TreeScreen1(this.isAnimation,{Key? key}) : super(key: key);

  bool isAnimation;

  @override
  // ignore: library_private_types_in_public_api
  _TreeScreen1State createState() => _TreeScreen1State();
}

class _TreeScreen1State extends State<TreeScreen1> with TickerProviderStateMixin{
  ...
  bool _isSeedLevelSetting = false;
  bool _isLoading2 = true;
  int countNumber = -1;
  int countNumber2 = -1;
  bool showPopUpForSeedSelection = false;
  String popUpSelectionCheck = "";
  String errorMessage = "";
  bool isSeed1 = false;
  bool isSeed2 = false;
  bool isSeed3 = false;
  String? nextSeedLevel;
  ...
  List<Result>? seedsDetailsAtLevel;
  late SkippedReminderNotification skippedReminderNotification;
  TreeGrowthResponse treeGrowthResponse = TreeGrowthResponse(
      status: 0,
      responseCount: "0",
      gardenType: "",
      maxCount: "",
      ...
      seedCount: 0,
      nextLevel: 0,
      isPopUpForNewTreeSelection: false,
      mobileImageUrl: "",
      ipadImageUrl: "",
      mobilePreviousImageUrl: "",
      ipadPreviousImageUrl: ""
  );
  late GardenLevelResponse gardenLevelResponse;

  bool seed1Visible = true;
  bool seed2Visible = true;
  bool seed3Visible = true;
  String completedLevelNumber = "";
            ...
            builder: (BuildContext context, void Function(void Function()) setState) {
              return SafeArea(
                child: AlertDialog(
                  ...
                  content: SizedBox(
                    height: !isPhone ? MediaQuery.of(context).size.height/2.6 : MediaQuery.of(context).size.height/2.9,
                          ...
                          Container(
                            ...
                            Row(
                              children: [
                                ...
                                Visibility(
                                  visible: seedsDetailsAtLevel![0].seedUsed == "no",
                                  child: Expanded(
                                      child: InkWell(
                                    onTap: () {
                                      setState(() {
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          ...
                                          border: Border.all(color: isSeed1 ? AppColors.primaryColor : AppColors.backgroundColor)
                                      ),
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            child: CachedNetworkImage(
                                              imageUrl: seedsDetailsAtLevel![0].image!,
                                          ...
                                          Container(
                                            decoration: BoxDecoration(
                                              color: isSeed1 ? AppColors.primaryColor : AppColors.backgroundColor,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text("Seed 1",style: TextStyle(color: isSeed1 ? AppColors.backgroundColor : AppColors.textWhiteColor,fontSize:!isPhone ? AppConstants.headingFontSize : AppConstants.defaultFontSize ),)
                                              ],
                                            ),
                                          )
                                        ],
                                ...
                                Visibility(
                                  visible: seedsDetailsAtLevel![1].seedUsed == "no",
                                  child: Expanded(
                                      child: InkWell(
                                    onTap: () {
                                      setState(() {
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(5),
                                          border: Border.all(color:isSeed2 ? AppColors.primaryColor : AppColors.backgroundColor)
                                      ),
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: CachedNetworkImage(
                                              imageUrl: seedsDetailsAtLevel![1].image!,
                                              progressIndicatorBuilder: (context, url, downloadProgress) =>
                                                  Container(
                                                    margin: const EdgeInsets.only(
                                                        top: 100,
                                          ...
                                          Container(
                                            decoration: BoxDecoration(
                                                color: isSeed2 ? AppColors.primaryColor : AppColors.backgroundColor,
                                                borderRadius:const BorderRadius.only(bottomLeft: Radius.circular(5),bottomRight: Radius.circular(5)),
                                                border: Border.all(color: AppColors.primaryColor)
                                            ),
                                            child: Row(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: [
                                                Text("Seed 2",style: TextStyle(color: isSeed2 ? AppColors.backgroundColor : AppColors.textWhiteColor,fontSize: !isPhone ? AppConstants.headingFontSize : AppConstants.defaultFontSize ),)
                                              ],
                                            ),
                                          )
                                        ],
                                ...
                                Visibility(
                                    visible: seedsDetailsAtLevel![2].seedUsed == "no",
                                    child: const SizedBox(width: 3,)),
                                Visibility(
                                  visible: seedsDetailsAtLevel![2].seedUsed == "no",
                                  child: Expanded(
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(5),
                                              border: Border.all(color:isSeed3 ? AppColors.primaryColor : AppColors.backgroundColor)
                                          ),
                                          child: Column(
                                            mainAxisSize: MainAxisSize.min,
                                            children: [
                                              Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: seedsDetailsAtLevel![2].image!,
                                                  progressIndicatorBuilder: (context, url, downloadProgress) =>
                                                      Container(
                                                        margin: const EdgeInsets.only(
                                                            top: 100,
                                              ...
                                              Container(
                                                decoration: BoxDecoration(
                                                    color: isSeed3 ? AppColors.primaryColor : AppColors.backgroundColor,
                                                    borderRadius:const BorderRadius.only(bottomLeft: Radius.circular(5),bottomRight: Radius.circular(5)),
                                                    border: Border.all(color: AppColors.primaryColor)
                                                ),
                                                child: Row(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Seed 3",style: TextStyle(color: isSeed3 ? AppColors.backgroundColor : AppColors.textWhiteColor,fontSize: !isPhone ? AppConstants.headingFontSize : AppConstants.defaultFontSize ),)
                                                  ],
                                                ),
                                              )
                                            ],
                          ...
                          Center(
                            child: Container(
                              ...
                              child: ElevatedButton(
                                onPressed: (){
                                  if(isSeed1 || isSeed2 || isSeed3) {
                                    if(isSeed1) {
                                      _setTreeType(seedsDetailsAtLevel![0].id.toString(),seedsDetailsAtLevel![0].level.toString());
                                    } else if(isSeed2) {
                                      _setTreeType(seedsDetailsAtLevel![1].id.toString(),seedsDetailsAtLevel![1].level.toString());
                                    } else {
                                      _setTreeType(seedsDetailsAtLevel![2].id.toString(),seedsDetailsAtLevel![2].level.toString());
                                    }
                                  } else {
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  minimumSize: Size(MediaQuery.of(context).size.width/2,!isPhone ? 40 : 30), // Set the minimum width and height
                                  padding: EdgeInsets.zero, // Remove any default padding
                                ),
                                child: SingleChildScrollView(
                                    scrollDirection: Axis.vertical,
                                    child: Text("Continue",style: TextStyle(color: AppColors.backgroundColor,fontSize: !isPhone ? AppConstants.headingFontSize : AppConstants.defaultFontSize),)),),
                            )
                          )
                        ],
                      ),
  ...
  _setTreeType(String seedId1,String levelNumber1) {
    setState(() {
      _isSeedLevelSetting = true;
      confettiController.stop();
    });
    HTTPManager().setTreeGrowthType(SetTreeGrowthTypeRequestModel(userId: id,seedId: seedId1,levelId: levelNumber1)).then((value) async {
      SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
      sharedPreferences.setString(UserConstants().userGardenLevel, value['new_level']['level']);
      sharedPreferences.setString(UserConstants().userGardenName, value['new_level']['seed']);
      treeGrowthResponse.seedCount == 1 || treeGrowthResponse.seedCount == 2 ? showToastMessage(context,"Seed updated successfully",true) : showToastMessage(context,"level updated successfully",true);
      setState(() {
        _isSeedLevelSetting = false;
      });
      if(treeGrowthResponse.seedCount == 2)
      {
        Navigator.of(context).pop();
      }
      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) =>TreeScreen1(false)));
      // _changeImage(0);
    }).catchError((e) {
      print(e);
  ...
  void _changeImage(TreeGrowthResponse treeGrowthResponse) {
    ...
    if(!widget.isAnimation) {
      setState(() {
        ...
        popUpSelectionCheck = "";
        if(!isPhone) {
          url = treeGrowthResponse.ipadImageUrl!;
        } else {
          url = treeGrowthResponse.mobileImageUrl!;
        }
      ...
      if (int.parse(treeGrowthResponse.responseCount!.toString()) == 0) {
        setState(() {
      ...
      } else if (int.parse(treeGrowthResponse.responseCount!.toString()) >=
          int.parse(treeGrowthResponse.maxCount!)) {
        setState(() {
          ...
          Future.delayed(const Duration(seconds: 3)).then((value) {
            ...
            setState(() {
              showPopUpForSeedSelection =
                  treeGrowthResponse.isPopUpForNewTreeSelection!;
              popUpSelectionCheck = treeGrowthResponse.isPopUpForNewTreeSelection!.toString();
              _showFirstImage = false;
        ...
        setState(() {
          ...
          controllerForward.reverse();
          if (!isPhone) {
            url = treeGrowthResponse.ipadPreviousImageUrl!;
          } else {
            url = treeGrowthResponse.mobilePreviousImageUrl!;
          }
          Future.delayed(const Duration(seconds: 3)).then((value) {
            Future.delayed(const Duration(seconds: 5)).then((value) {
              setState(() {
  ...
  _getTreeGrowth() async {
    ...
    HTTPManager().treeGrowth(LogoutRequestModel(userId: id.toString())).then((value)  {
      ...
      setState(() {
        ...
        sharedPreferences.setString("Score", treeGrowthResponse.responseCount.toString());
        sharedPreferences.setString("MobileImageURL", treeGrowthResponse.mobileImageUrl.toString());
        sharedPreferences.setString("IpadImageURL", treeGrowthResponse.ipadImageUrl.toString());
      });

      _getGardenLevelList();
      if(treeGrowthResponse.currentStatus == "incomplete") {

        _getSeedLevelDetail(treeGrowthResponse.currentLevel!.toString());
      } else {
        _getSeedLevelDetail(treeGrowthResponse.nextLevel.toString());
      }
      _changeImage(treeGrowthResponse);
  ...
  _getGardenLevelList() {
    ...
    HTTPManager().gardenLevelList().then((value) {
      setState(() {
        gardenLevelResponse = value;
        _isLoading2 = false;
      });
      for(int i= 0; i<gardenLevelResponse.gardenLevelListResponseData!.length; i++) {
        if(treeGrowthResponse.currentLevel == gardenLevelResponse.gardenLevelListResponseData![i].id) {
          print("gardenLevelResponsegardenLevelResponse");
          print(numberKeys[gardenLevelResponse.gardenLevelListResponseData![i].slug!]);
          setState(() {
            completedLevelNumber = numberKeys[gardenLevelResponse.gardenLevelListResponseData![i].slug!].toString();
            completedLevelName = gardenLevelResponse.gardenLevelListResponseData![i].name!;
          });
        }
      }
    }).catchError((e) {
      print("GARDEN LEVEL ERROR");
      print(e.toString());
      setState(() {
        _isLoading2 = false;
      });
  ...
  _getSeedLevelDetail(String seedLevelId) async {
    setState(() {
      _isLoading2 = true;
      nextSeedLevel = seedLevelId;
    });
    print("Seed Level ID GETTING");
    print(seedLevelId);

    HTTPManager().getGardenSeeds(GardenSeedRequestModel(seedLevel: seedLevelId,userId: id)).then((value)  {

      setState(() {
        seedsDetailsAtLevel = value.result;
        errorMessage = "";
        _isLoading2 = false;
      });
    }).catchError((e) {
      print("Seed LEVEL API");
      print(e.toString());
      setState(() {
        _isLoading2 = false;
        errorMessage = e.toString();
  ...
  _getUserData() async {
    ...
    seedLevel = sharedPreferences.getString(UserConstants().userGardenLevel)!;
    seedId = sharedPreferences.getString(UserConstants().userGardenName)!;
                              ...
                              children: [
                                TextButton(onPressed: () {
                                  ...
                                  HTTPManager().postReminderStopData(ReminderNotificationForStopRequestModel(notificationId: notificationId,reminderStop: "no")).then((value) {
                                    ...
                                    // }
                                    Navigator.of(context).pop();
                                    showToastMessage(context,"Reminder stopped for today!", true);
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            InkWell(
              onTap: () {
                if(!_isLoading2 && !_showFirstImage) {
                  ...
                  if (treeGrowthResponse.seedCount == 2) {
                    for(int i = 0;i<seedsDetailsAtLevel!.length; i++) {
                      if(seedsDetailsAtLevel![i].seedUsed == "no") {
                        _setTreeType(seedsDetailsAtLevel![i].id.toString(),
                            seedsDetailsAtLevel![i].level.toString());
                      }
                    }
                  } else if (treeGrowthResponse.isPopUpForNewTreeSelection!) {
                      showPopupDialogueForTreeSelection();
                  } else {
              ...
              ) :treeGrowthResponse.ipadImageUrl == "" ? Center(
                child: Container()
              ) : Container(
                height: MediaQuery.of(context).size.height,
                color: treeGrowthResponse.currentLevel == "2" ? int.parse(treeGrowthResponse.responseCount!) > 3 && treeGrowthResponse.gardenType == 'rose' || int.parse(treeGrowthResponse.responseCount!) > 1 && treeGrowthResponse.gardenType == 'tomato'?  AppColors.skyColorForTreeSection : AppColors.backgroundColor : AppColors.backgroundColor,
                alignment: Alignment.bottomCenter,
                child: !showPopUpForSeedSelection ? widget.isAnimation ? AnimatedBuilder(
                          ...
                          const SizedBox(height: 5,),
                           Row(
                            ...
                            children: [
                              ...
                              treeGrowthResponse.seedCount == 2 || treeGrowthResponse.seedCount == 1 && treeGrowthResponse.currentLevel != "1" ? Text("Seed${treeGrowthResponse.seedCount} : ${treeGrowthResponse.gardenType}",style: const TextStyle(color:AppColors.primaryColor,fontSize: AppConstants.columnDetailsScreenFontSize),) :Text("Level$completedLevelNumber : $completedLevelName",style: const TextStyle(color:AppColors.primaryColor,fontSize: AppConstants.columnDetailsScreenFontSize),),
                            ],
                          )
                        ],
                      )
                      ...
                      child: Card(
                        color: AppColors.primaryColor,
                          ...
                          child: Container(
                              ...
                              child: const Text("Tap to proceed!",style: TextStyle(fontWeight: FontWeight.normal,fontSize: AppConstants.defaultFontSize),))),
            ),
                 ),
               ),
             ),
            InkWell(
              ...
              child: Visibility(
                visible: !showPopUpForSeedSelection,
                child: Align(
                  alignment: Alignment.topCenter,
                  child: Column(
                    children: [
                      ...
                      _isLoading2 ? Container() : Container(
                          padding:const EdgeInsets.symmetric(horizontal: 10),
                          margin:const EdgeInsets.only(top: 20),
                          child: Text("Level$completedLevelNumber: $completedLevelName",style:const TextStyle(fontSize: AppConstants.headingFontSizeForEntriesAndSession,color: AppColors.primaryColor),textAlign: TextAlign.center,)),
                    ],
                  ),
                ),
              ),
            ...
            Align(
              alignment: Alignment.topCenter,
              child: _isSeedLevelSetting ? Container(
...
//
//   ImageLoadingWidget({required this.imageUrl});
//
//   @override
//   Widget build(BuildContext context) {
...
//           return child;
//         } else {
//           // Show a loading indicator or progress information.
