        ...
        return  StatefulBuilder(
          builder: (BuildContext context, void Function(void Function()) setState) {
            return AlertDialog(
              ...
              content: SizedBox(
                height: !isPhone ? MediaQuery.of(context).size.height/1.5 : MediaQuery.of(context).size.height/2.5,
    ...
    return StatefulBuilder(builder: (BuildContext context,StateSetter setState) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Container(
                padding:!isPhone ? const EdgeInsets.symmetric(vertical: 5) : const EdgeInsets.symmetric(vertical: 5),
                width: MediaQuery.of(context).size.width,
