...
import '../model/request_model/change_request_model.dart';
...
import '../model/request_model/forgot_password_request.dart';
...
import '../model/request_model/naq_request_model.dart';
...
class HTTPManager {
  ...
  Future<QuestionListModel> getQuestions(String questionListType) async {
    ...
    String url = ApplicationURLs.API_QUESTIONS;
    // ignore: avoid_print
    print(url);
  ...
  Future<NaqModelClassResponse> getNaqQuestions(NaqQuestionRequestModel naqQuestionRequestModel) async {
    ...
    final response =
    await _handler.post(Uri.parse(url),naqQuestionRequestModel.toJson());
  ...
  Future<dynamic> deleteUser(LogoutRequestModel logoutRequestModel) async {

    String url = ApplicationURLs.API_DELETE;
    // ignore: avoid_print
    print(url);
...
//Trellis Api's Manager
  ...
  Future<dynamic> trellisRead(TrellisRequestModel trellisRequestModel) async {
    ...
    // print
    // ignore: avoid_print
    print('Trellis Read ===========> $url');
    print('Data ===========> ${trellisRequestModel.toJson()}');
  ...
  Future<dynamic> trellisUpdateVision(TrellisUpdateVisionRequestModel trellisUpdateVisionRequestModel) async {

    String url = ApplicationURLs.API_TRELLIS_UPDATE_VISION;
    // ignore: avoid_print
    print(url);

    final response =
    await _handler.post(Uri.parse(url),trellisUpdateVisionRequestModel.toJson());
    // QuestionListModel questionAnswerResponseModel = QuestionListModel.fromJson(response["questions"]);
    // ignore: avoid_print
    print(response.toString());
    return response;
  ...
  Future<dynamic> cancelSubscription(StripeCancelRequestModel stripeCancelRequestModel) async {
    ...
    // ignore: avoid_print
    print(url);
    print(jsonEncode(stripeCancelRequestModel.toJson()));
    final response =
  ...
  Future<dynamic> acceptNotificationInvite(String senderId,String recieverId, String role) async {
    ...
    String url = "${ApplicationURLs.API_SAGE_ACCEPT_CONNECTION}?receiver_role=$role&sender_id=$senderId&receiver_id=$recieverId";
    // ignore: avoid_print
    print(url);
  ...
  Future<dynamic> rejectNotificationInvite(String senderId,String recieverId, String role) async {
    ...
    String url = "${ApplicationURLs.API_SAGE_REJECT_CONNECTION}?receiver_role=$role&sender_id=$senderId&receiver_id=$recieverId";
    // ignore: avoid_print
    print(url);
